...
def print_one_cube(width, id_offset=0, offset=(0, 0, 0)):
    """
        ...
        @param width: slide width (we assume this is the larger slide
            dimension)
        @param id_offset: integer saying how many to add to each slide
            number (the number that is visible in the slide and the
            HTML comment)
